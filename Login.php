...
<form>
<table align="middle">
<tr><td colspan="3"><font size="10" color="white" face="viner hand ITC">Ingreso</font></td></tr>
<tr><td rowspan="3"><img src="Imagenes/login.png" width="100" height="100"></td>
<td><font face="Calibri Light"color="white" size="5">Usuario:</font></td><td><input type="text" name="Usuario" required=""> </td> </tr>
<tr></td><td><font face="Calibri Light" color="white" size="5">Contrasena:</font></td><td><input type="password"name="contrasena" required=""></input></td></tr>
